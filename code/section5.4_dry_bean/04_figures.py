# -*- coding: utf-8 -*-
"""Generate the external-validity figures on the real Dry Bean dataset."""
import matplotlib
matplotlib.use("Agg")
...
FIG_DIR = BASE + "/figures/section5.4_dry_bean"
RESULTS_DIR = BASE + "/results/section5.4_dry_bean"
os.makedirs(FIG_DIR, exist_ok=True)
plt.rcParams["figure.dpi"] = 600  # publication-quality raster resolution
plt.rcParams["font.size"] = 10

grid = pd.read_csv(RESULTS_DIR + "/real_blindspot_grid_results.csv")
binary = pd.read_csv(RESULTS_DIR + "/algorithm_comparison_binary.csv")
multi = pd.read_csv(RESULTS_DIR + "/algorithm_comparison_multiclass.csv")
...
print("Four figures saved to:", FIG_DIR)
