# -*- coding: utf-8 -*-
"""Generate the figures for Section 5.1 (Blind Spot Map) and Section 5.2
...
FIG_DIR = BASE + "/figures/section4"
os.makedirs(FIG_DIR, exist_ok=True)
plt.rcParams["figure.dpi"] = 600  # publication-quality raster resolution
plt.rcParams["font.size"] = 10

summary = pd.read_csv(BASE + "/results/section4/blindspot_grid_summary.csv")

# ---------- Figure 1: mean ARI map ----------
...
# ---------- Figure 2: minimum separation needed for ARI>=0.5 ----------
...
print(f"\nSaved: {FIG_DIR}/fig1_blindspot_map.png")
print(f"Saved: {FIG_DIR}/fig2_min_separation_curve.png")
