...
OUT_CSV_NATURAL = OUT_DIR + "/geometric_criterion_natural_results.csv"
OUT_CSV_GRID = OUT_DIR + "/geometric_criterion_grid_results.csv"
OUT_FIG = FIG_DIR + "/fig14_geometric_criterion_ieee.png"
