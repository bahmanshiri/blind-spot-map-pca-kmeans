# -*- coding: utf-8 -*-
"""Generate the figures for Section 5.3: Figure 3 (final k=3 clustering in PCA
space) and Figure 4 (k-selection curves)."""
import os
import sys
import numpy as np
import pandas as pd
...
# ---------- Figure 3: final clustering (k=3) in PCA space ----------
...
print(f"\nSaved: {FIG_DIR}/fig3_final_clustering_pca.png")
print(f"Saved: {FIG_DIR}/fig4_k_selection_curves.png")
